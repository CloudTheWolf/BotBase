...
namespace Level.Module.Commands
{
    public class LevelCommands : BaseCommandModule
    {
        ...
        public static async Task Client_MessageCreated(MessageCreateEventArgs e)
        {
            if (e.Author.IsBot) return;
            await DatabaseActions.GiveExp(e.Author.ToString());
        }

        public static async Task Client_MessageDeleted(MessageDeleteEventArgs e)
        {
